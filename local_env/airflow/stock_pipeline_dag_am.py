...
with DAG(
    dag_id='bigdata_stock_pipeline_11h45',
    default_args=default_args,
    description='Luồng xử lý chứng khoán - Lượt sáng 11h45',
    schedule='45 4 * * 1-5',
    ...
    # ĐỊNH NGHĨA SPARK THEO TỪNG CỤM ANH EM (MỖI NGƯỜI 2 FILE)
    # 1. Cụm Bảo
